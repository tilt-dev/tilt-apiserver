...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/tilt-dev/tilt-apiserver/pkg/apis/core/v1alpha1.Manifest":       schema_pkg_apis_core_v1alpha1_Manifest(ref),
		"github.com/tilt-dev/tilt-apiserver/pkg/apis/core/v1alpha1.ManifestList":   schema_pkg_apis_core_v1alpha1_ManifestList(ref),
		"github.com/tilt-dev/tilt-apiserver/pkg/apis/core/v1alpha1.ManifestSpec":   schema_pkg_apis_core_v1alpha1_ManifestSpec(ref),
		"github.com/tilt-dev/tilt-apiserver/pkg/apis/core/v1alpha1.ManifestStatus": schema_pkg_apis_core_v1alpha1_ManifestStatus(ref),
...
func schema_pkg_apis_core_v1alpha1_Manifest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/tilt-dev/tilt-apiserver/pkg/apis/core/v1alpha1.ManifestSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/tilt-dev/tilt-apiserver/pkg/apis/core/v1alpha1.ManifestStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/tilt-dev/tilt-apiserver/pkg/apis/core/v1alpha1.ManifestSpec", "github.com/tilt-dev/tilt-apiserver/pkg/apis/core/v1alpha1.ManifestStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_core_v1alpha1_ManifestList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/tilt-dev/tilt-apiserver/pkg/apis/core/v1alpha1.Manifest"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/tilt-dev/tilt-apiserver/pkg/apis/core/v1alpha1.Manifest", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
