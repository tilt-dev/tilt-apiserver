...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		v1alpha1.Manifest{}.OpenAPIModelName():            schema_pkg_apis_core_v1alpha1_Manifest(ref),
		v1alpha1.ManifestList{}.OpenAPIModelName():        schema_pkg_apis_core_v1alpha1_ManifestList(ref),
		v1alpha1.ManifestSpec{}.OpenAPIModelName():        schema_pkg_apis_core_v1alpha1_ManifestSpec(ref),
		v1alpha1.ManifestStatus{}.OpenAPIModelName():      schema_pkg_apis_core_v1alpha1_ManifestStatus(ref),
...
func schema_pkg_apis_core_v1alpha1_Manifest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.ManifestSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.ManifestStatus{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v1alpha1.ManifestSpec{}.OpenAPIModelName(), v1alpha1.ManifestStatus{}.OpenAPIModelName(), v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_core_v1alpha1_ManifestList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1alpha1.Manifest{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.Manifest{}.OpenAPIModelName(), v1.ListMeta{}.OpenAPIModelName()},
	}
}
